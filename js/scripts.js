// Les mots se trouvent dans data/mots.js
...
$(function() {
  ...
  function newGame(listOfWords) {
    ...
    $('#incorrect-guesses h3').empty().append("Lettres erron&eacute;es&nbsp;: ");
    ...
    $(".letter-choice").click(function() {
      ...
      if (game.hasBeenGuessed(guessedLetter)) {
        ...
        alert("Cette lettre a d&eacute;j&agrave; &eacute;t&eacute; choisie.");
      } else {
